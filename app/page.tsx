...
export default function Home() {
  return (
    <div className="dark grid items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      ...
      <a href="https://www.facebook.com/cetis161tala/">
        ...
        <p className="mt-4 text-center text-sm text-gray-600">
          ¿No tienes una cuenta? <a href="./pages/Hola" className="text-blue-500 hover:underline">Regístrate</a>
        </p>
      </form>
    </div>
  );
